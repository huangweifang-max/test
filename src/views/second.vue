<template>
  <div class="container">
    <div class="head">
      ...
      <div class="buttons">
      <el-button type="primary" plain  @click="autodate" >重置</el-button>
      <el-button type="primary" plain  @click="fifteendate">近15天</el-button>
      <el-button type="primary" plain  @click="thirdtydate">近30天</el-button>
      <el-button type="primary" plain  @click="ninetydate">近90天</el-button>
      </div>
      <el-date-picker
        v-model="value1"
        type="daterange"
      ...
      ></el-date-picker>
      <div class="demonstration" style="float:right">
        <i class="el-icon-date">数据时间：</i>
      </div>
    </div>
    ...
    <div class="main">
      <div class="left-1">
        <div class="left-11">
          <div style="height:50px;width:800px;padding:20px">
            <el-row style="text-align:center">
              <el-col
                :span="6"
                style="color:red;margin-right:20px;font-size:20px"
                class="overview-item-value"
              >
                <strong>3</strong>
              </el-col>
              <el-col
                :span="6"
                style="color:black;margin-right:20px;font-size:20px"
                class="overview-item-value"
              >
                <strong>3</strong>
              </el-col>
              ...
              >
                <strong>32</strong>
                <span style="color:gray;font-size:13px">分钟</span>
              </el-col>
            </el-row>
        ...
        <div id="zhext" class="left-12"></div>
        <div class="left-13">
          <div id="piet" style="width:750px;height:370px"></div>
          <div id="overflow">
            <el-menu>
              <el-submenu index="1">
                <template slot="title">
                  <i class="el-icon-arrow-up">IaaS</i>
                </template>
                <div id="el-1">
                  <span>主机</span>
                ...
                <div id="el-1">
                  <span>防火墙</span>
                  <el-progress :stroke-width="10" :percentage="66" :format="format"></el-progress>
                </div>
                <div id="el-1">
                  <span>交换机</span>
                  <el-progress :stroke-width="10" :percentage="33" :format="format"></el-progress>
                </div>
              </el-submenu>
              <el-submenu index="2">
                <template slot="title">
                  <i class="el-icon-arrow-up">PaaS</i>
                </template>
                <div id="el-1">
                  <span>Mysql</span>
                  <el-progress
              ...
              <el-submenu index="3">
                <template slot="title">
                  <i class="el-icon-arrow-up">SaaS</i>
                </template>
                <div id="el-1">
                  <span>应用</span>
                  <el-progress
      ...
      <div class="right-1">
        <div id="zhuxt" class="right-11"></div>
        <div id="info" class="right-12">
          <span style="font-size:20px">
            <strong>故障影响的资源 TOP5</strong>
          </span>
...
export default {
  data() {
    return {
      ...
      saasColor: "#E8C940",
      tabledata: [
        { resname: "【服务】服开轮询接受接口", ifnumber: "10" },
